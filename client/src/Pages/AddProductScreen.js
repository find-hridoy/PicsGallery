...
const AddProductScreen = () => {
   ...
   const onSubmit = async (data) => {
      ...
      try {
         const res = await fetch('https://api.cloudinary.com/v1_1/dvrlnpthq/image/upload', {
            method: 'POST',
            body: formData,
         });
         ...
         if (image) {
            // DISPATCH
            dispatch(productCreate(title, description, category, subCategory, price, image));
         } else {
            ...
            <div className="addProduct__form">
               <form onSubmit={handleSubmit(onSubmit)}>
                  <div className="addProduct__field">
                     ...
                     <input className="addProduct__input" type="text" {...register('title')} />
                  ...
                  <div className="addProduct__field">
                     ...
                     {errors.subCategory && (
                        <span className="addProduct__">{errors.subCategory.message}</span>
                     )}
                  </div>
                  ...
                  <div className="addProduct__divider">
                     <div className="addProduct__field">
                        ...
                        <input className="addProduct__input" type="number" {...register('price')} />
                        {errors.price && (
                  ...
                  <button type="submit" className="addProduct__button">
                     {loading ? (
                        <Loader type="ThreeDots" color="#FFFFFF" height={13} width={100} />
                     ) : (
                        'Add Product'
                     )}
                  </button>
