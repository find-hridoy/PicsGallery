   ...
   <footer>
      <div className="footer__area">
         <div className="footer__part1">
            ...
            <div className="footer__slogan">High quality items created by global community.</div>
      ...
      <p className="footer__copyrights">Copyrights &copy; PicsGallery. All Rights Reserved.</p>
   </footer>
);
